...
import { Calendar, DollarSign, Users, TrendingUp, Clock, Trophy, Bell, Search, Settings, LayoutDashboard, MapPin, CreditCard, BarChart3, Menu, X, Image as ImageIcon, Phone, Mail, Upload } from 'lucide-react';
...
export default function FutsalApp() {
  ...
  const stats = [
    ...
    { label: 'Monthly Revenue', value: 'NPR 2.4L', change: '+12% from last month', icon: DollarSign, color: 'bg-green-500' },
...
//Complete Courts and Pricing page