...
import {
  MapPin, Star, Clock, DollarSign, Calendar, Users,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mt-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Courts ({venue.courts?.length || 0})</h3>
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-3">
                          <div>
                            ...
                            <p className="font-semibold text-gray-900">
                              {formatCurrency(court.pricing.weekdayRate)}/hr
                            </p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-500">Weekend</p>
                            <p className="font-semibold text-gray-900">
                              {formatCurrency(court.pricing.weekendRate)}/hr
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mt-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">
                  Gallery ({(venue.media?.images?.length || 0) + (venue.media?.videos?.length || 0)} items)
                </h3>

                {/* Images */}
                {venue.media?.images && venue.media.images.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-gray-700 mb-3 flex items-center gap-2">
                      <ImageIcon className="w-4 h-4" />
                      Images ({venue.media.images.length})
                    </h4>
                    <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                      {venue.media.images.slice(0, 6).map((img, idx) => (
                    ...
                    {venue.media.images.length > 6 && (
                      <p className="text-sm text-gray-500 mt-2">
                        +{venue.media.images.length - 6} more images
                      </p>
                    )}
                  </div>
                )}
                ...
                {venue.media?.videos && venue.media.videos.length > 0 && (
                  <div>
                    <h4 className="text-sm font-medium text-gray-700 mb-3 flex items-center gap-2">
                      ...
                      Videos ({venue.media.videos.length})
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {venue.media.videos.slice(0, 2).map((vid, idx) => (
                    ...
                    {venue.media.videos.length > 2 && (
                      <p className="text-sm text-gray-500 mt-2">
                        +{venue.media.videos.length - 2} more videos
                      </p>
                    )}
                  </div>
                )}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                {venue.facilities && venue.facilities.length > 6 && (
                  <p className="text-sm text-gray-500 mt-3">
                    +{venue.facilities.length - 6} more facilities
                  </p>
                )}
              </div>
              ...
              {(venue.socialMedia?.facebook || venue.socialMedia?.instagram || 
                venue.socialMedia?.twitter || venue.socialMedia?.website) && (
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Social Media</h3>
                  <div className="space-y-3">
                    {venue.socialMedia.facebook && (
                      
                    <a  href={venue.socialMedia.facebook}
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <a href={venue.socialMedia.instagram}
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <a href={venue.socialMedia.website}
                        target="_blank"
                        rel="noopener noreferrer"
